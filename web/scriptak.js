...
function inprimituHizt() {
	...
	document.getElementById("inprimatuHitzBotoia").src="img/interface/inprimatu1.png";
...
function inprimituJokoa() {
	...
	document.getElementById("inprimatuJokoaBotoia").src="img/interface/zoriesataria1.png";
